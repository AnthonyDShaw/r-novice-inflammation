...
# Instead, please edit 03-loops-R.md in _episodes_rmd/
...
> speed of your code.
> [For instruction on best practices, see this supplementary lesson that demonstrates operations in R.]({{ page.root }}/15-supp-loops-in-depth/) 
{: .callout}
